	...
	<body class="index loading">
		...
		<!-- Header -->
			<header id="header" class="alt">
				<h1 id="logo"><a href="/">Mercury <span>瓶中信 </span></a><span class="icon fa-envelope"> 屬於我的故事 / 回覆</span></h1>
				<nav id="nav">
					<ul>
						...
						<!-- Content -->
							...
							?>
								...
								?>
										...
										<br>
										<span style="font-size:13px; font-weight:300;">
										<?php echo $reply['user_school'].' '.$reply['user_department'].' ';?>
								...
								?>
										...
										<form id="response_form" method="post" action="/api/story_response">
											<div class="" style="margin-bottom:1em;">
												...
												<textarea class="story_footer letter-content" name="response_content" id="response_content" rows="5" placeholder="To <?php echo $reply_nickname?>，我..."></textarea>
											</div>
